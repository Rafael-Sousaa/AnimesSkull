import { CarouselInterface } from '@shared/interfaces'

const CarouselMock: Array<CarouselInterface> = [
  {
    titulo: 'Bleach: Sennen Kessen-hen',
    sinopse: `Ichigo Kurosaki é um estudante normal do ensino médio, até que sua
    família é atacada por um Hollow, um espírito corrupto que busca
    ...
    imagem: '/images/carousel/ichigocarousel.jpg'
  },
  {
    titulo: 'Chainsaw Man',
    sinopse: `Denji tem um sonho simples – viver uma vida feliz e pacífica, passando um tempo com uma garota de quem gosta. Isso está muito longe da realidade, no entanto, já que Denji é forçado pela yakuza a matar demônios para pagar suas dívidas esmagadoras. Usando seu demônio de estimação Pochita como arma, ele está pronto para fazer qualquer coisa por um pouco de dinheiro.`,
    link: '/animes/chainsaw-man',
    imagem: '/images/carousel/chaisawmancarousel.jpg'
  },
  {
    titulo: 'One Piece',
  ...
  },
  {
    ...
    link: '/animes/boku-no-hero-academia',
    imagem: '/images/carousel/bokunoherocarousel.jpg'
  },
  {
    titulo: 'Blue Lock',
    ...
    link: '/animes/blue-lock',
    imagem: '/images/carousel/bluelockcarousel.jpg'
  }
]

export default CarouselMock
